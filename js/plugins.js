...
(function (e) {
    let t = {
        ...
        const t = n.scrollTop(), o = r.height(), u = o - s, a = t > u ? u - t : 0;
        for (let f = 0; f < i.length; f++) {
            const l = i[f], c = l.stickyWrapper.offset().top, h = c - l.topSpacing - a;
            if (t <= h) {
                ...
                let p = o - l.stickyElement.outerHeight() - l.topSpacing - l.bottomSpacing - t - a;
                if (p < 0) {
                    p = p + l.topSpacing
                } else {
                    p = l.topSpacing
        ...
        init: function (n) {
            const r = e.extend(t, n);
            return this.each(function () {
                const t = e(this);
                const n = t.attr("id");
                const s = e("<div></div>").attr("id", n + "-sticky-wrapper").addClass(r.wrapperClassName);
                t.wrapAll(s);
                if (r.center) {
            ...
            return this.each(function () {
                ...
                for (let n = 0; n < i.length; n++) {
                    if (i[n].stickyElement.get(0) === t.get(0)) {
                        removeIdx = n
                    }
                }
                if (removeIdx !== -1) {
                    i.splice(removeIdx, 1);
                    t.unwrap();
                    t.removeAttr("style")
                }
            })
